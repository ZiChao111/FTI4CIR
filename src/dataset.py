        ...
        try:
            if self.mode == 'relative':
                ...
                if self.split in ['train', 'val']:
                    reference_image_path = self.dataset_path / self.dress_types[0] / f"{reference_name}.jpg"
                    reference_image = self.preprocess(PIL.Image.open(reference_image_path))
                    target_name = self.triplets[index]['target']
                    target_image_path = self.dataset_path / self.dress_types[0] / f"{target_name}.jpg"
                ...
                image_path = self.dataset_path / self.dress_types[0] / f"{image_name}.jpg"
